...
public class holderadaptersliderinsearch  extends RecyclerView.Adapter<holderadaptersliderinsearch.holder> implements Filterable {
    ...
    @Override
    public void onBindViewHolder(@NonNull holderadaptersliderinsearch.holder holder, int position) {
